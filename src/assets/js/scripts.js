            ...
            y = function (e) {
                ...
                return {
                    ...
                    modifiers: [
                        ...
                        { name: "preventOverflow", options: { altAxis: !1 !== x(e, "flip") } },
...
var KTSticky = function (e, t) {
    var n = this,
        i = document.getElementsByTagName("BODY")[0];
    if (null != e) {
        var r = { offset: 200, flipOffset: 0, reverse: !1, animation: !0, animationSpeed: "0.3s", animationClass: "animation-slide-in-down" },
            o = function () {
                (n.element = e),
                    (n.options = KTUtil.deepExtend({}, r, t)),
...
var KTLayoutAside = {
    init: function () {
        document.querySelector("#kt_aside_categories_toggle").addEventListener("click", function (e) {
            e.preventDefault(), "More Categories" === this.innerHTML ? (this.innerHTML = "Less Categories") : (this.innerHTML = "More Categories");
        });
    },
};
KTUtil.onDOMContentLoaded(function () {
...
var KTLayoutSidebar = {
    init: function () {
        var e;
        (e = document.querySelector("#kt_sidebar_search_form")).querySelector(".form-control").addEventListener("keyup", function (t) {
            "Enter" === t.code && (t.preventDefault(), (window.location.href = e.getAttribute("action")));
        });
    },
};
KTUtil.onDOMContentLoaded(function () {
