												...
												<div class="d-flex justify-content-between align-items-start mb-2">
													<div class="d-flex flex-column">
														<div class="d-flex align-items-center mb-2">
															<span class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">Fajar Rivaldi Chan</span>
													...
													<div class="d-flex my-4 ms-2">
														<a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal">Keluar</a>
													</div>
												</div>
												<div class="d-flex">
													<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 text-end">
                    ...
                    <div class="separator separator-dashed border-gray-300 px-0 mx-0"></div>
										...
										<div class="d-flex overflow-auto h-55px">
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
												...
												<li class="nav-item">
													<a class="nav-link text-active-primary me-6" href="#">Kelas</a>
												</li>
											</ul>
										</div>
                  </div>
